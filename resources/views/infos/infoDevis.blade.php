                ...
                <div id="invoice-company-details" class="row">
                    <div class="col-6 text-left">
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="h5">CLient : {{$dev->client->nom}}</li>
                            <li class="h5">Adresse : {{$dev->client->adresse}}</li>
                            <li class="h5">Tel : {{$dev->client->tel}}</li>
                            <li class="h5">Email : {{$dev->client->email}}</li>
                        </ul>
                        </ul>
                    </div>
                    <div class="col-md-6 text-right">
                        <h2 class="h1">Devis</h2>
                        <p class=" h5">Date: {{$dev->date}}</p>
                        <p class="text-bold h5"># Devis-{{$dev->id}}</p>
                    </div>
                </div>
                <!--/ Invoice Company Details -->
                    ...
                    <div class="row">
                        <div class="table-responsive col-sm-12">
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($dev->devisItems as $key=>$item)
                                        <tr>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right h1">{{$dev->discount}}%</td>
                                        </tr>
                                        <tr class="bg-grey bg-lighten-4">
                                            <td class="text-bold h1">Montant Total:</td>
                                            <td class="text-bold h1 text-right">{{$dev->total_amount}} F CFA</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
