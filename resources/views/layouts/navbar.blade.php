              ...
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item mr-0"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-user-link dropdown-toggle"><span class="avatar avatar-online"><img id="navbar-avatar" src="storage/images/{{Auth::user()->avatar}}" alt="avatar"/></span>
                  ...
                  <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                    <div class="arrow_box_right">
                        <a href="{{route('profil')}}" class="dropdown-item py-1"><i class="icon-user mr-2"></i><span>Mon profil</span></a>
                        <a href="{{route('mdp')}}" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Mot de passe</span></a>
                        @if(Auth::user()->role === 'Admin')

                            <a href="{{route('setting')}}" class="dropdown-item py-1"><i class="ft-settings mr-2"></i><span>Paramètres</span></a>
                        @endif
