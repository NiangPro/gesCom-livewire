  <div data-active-color="white" data-background-color="crystal-clear" data-image="assets/img/sidebar-bg/08.jpg" class="app-sidebar">
            ...
            <div class="nav-container">
                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="icon-settings"></i><span data-i18n="" class="menu-title">Paramètres</span><span class="tag badge badge-pill badge-danger mt-1">@if (Auth::user()->role === 'Admin')
                        4
                        @else
                        2
                        @endif
                        ...
                        <ul class="menu-content">
                            <li  class="@if($page === 'profil')active @endif"><a href="{{route('profil')}}" class="menu-item">Profil</a>
                            </li>

                            @if (Auth::user()->role === 'Admin')
                                    <li  class="@if($page === 'setting')active @endif"><a href="{{route('setting')}}" class="menu-item">General</a>
                                </li>
                                <li class="@if($page === 'users')active @endif"><a href="{{route('users')}}" class="menu-item">Utilisateurs</a>
                                </li>
                            @endif
                            <li class="@if($page === 'mdp')active @endif"><a href="{{route('mdp')}}" class="menu-item">Mot de passe</a>
                            </li>
                        </ul>
                    </li>
                </ul>
